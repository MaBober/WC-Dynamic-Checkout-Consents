...
class WC_Dynamic_Consents_Helper {
    ...
    /**
     * Retrieves product and category IDs from the WooCommerce cart.
     *
     * Iterates through cart items to collect associated product and category IDs.
     *
     * @return array {
     *     @type array $product_ids  List of product IDs in the cart.
     *     @type array $category_ids List of category IDs associated with cart products.
     * }
     */
     ...
     * or categories.
     *
     * @param array $consent The consent configuration.
